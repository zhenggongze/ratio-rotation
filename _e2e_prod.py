...
with sync_playwright() as p:
    ...
    check('8-28全仓含mom10', '全仓' in d828 and '3.8%' in d828, d828[:150])
    ...
    check('行1含77.5%', '77.5%' in core_txt and '77.08万' not in core_txt, core_txt[:200])
    hold_txt = page.locator('#t0GridHold').inner_text()
    check('行2含6.3%超额', '相对满仓' in hold_txt and '6.3%' in hold_txt, hold_txt[:200])
    t0g_txt = page.locator('#t0GridT0').inner_text()
    check('行3含21.6%超额', '相对做T' in t0g_txt and '21.6%' in t0g_txt, t0g_txt[:200])
